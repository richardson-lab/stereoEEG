function [S, Serr, per, tau, exctn, lambda] = armodeFAST(A, C)
...
%
%  DR 06/2019 - commented out confidence interval/margin of error code to
%  speed execution and removed warning of unstable eigenmodes
...
%   Sigma_A  = kron(Uinv, C);
  ...
  % per and tau
  tau = zeros(2,m*p); % preallocation added by DR 08/2019
  exctn = zeros(1,m*p);
  per = zeros(2,m*p);
