...
%                                                 each trial -- required
%
%        MaxResponse    (1 x N vector)  total number that could be correct 
...
BackgroundProb=0.6;
MaxResponse= [8,3,9,9,9,5,14,13,15,7,6,7,7,9,10,13,14,15,16,18,22,26,30];
Responses= [4,3,3,3,2,3,10,11,12,3,5,6,7,8,9,12,14,15,16,18,22,25,26];
